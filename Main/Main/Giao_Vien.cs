        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            else if (chon == 2)
            {
                ...
                else
                {
                    ...
                    {
                        gv.ADDGiaoVien(txtHoTenGV.Text, cbGTGV.Text, DateTime.Parse(dtpNgaySinhGV.Text), txtDiaChi.Text, int.Parse(txtSDT.Text), int.Parse(txtLuong.Text), cbMonHoc.SelectedValue.ToString());
